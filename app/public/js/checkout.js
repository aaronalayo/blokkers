...
function getInfo() {
  ...
  if (nameFilter.test(String(shippingfullname).toLowerCase()) == false) {
    ...
    }else  if (nameFilter.test(String(billingfullname).toLowerCase()) == false) {
        alert("Enter a valid name for billing");
    }else if(billingfullname !== "" && nameFilter.test(String(billingfullname).toLowerCase()) == false ){
      alert("Enter a valid name for billing");
    } else if (billingphone !== "" && phoneFilter.test(String(billingphone).toLowerCase()) == false) {
      alert("Enter a valid phone number for billing");
    } else if (billingaddress !== "" && addressFilter.test(String(billingaddress).toLowerCase()) == false) {
      alert("Enter a valid address for billing");
    } else if (billingcity !== "" && cityFilter.test(String(billingcity).toLowerCase()) == false) {
      alert("Enter a valid city for billing");
    } else if (billingzip !== "" && zipFilter.test(String(billingzip).toLowerCase()) == false) {
      alert("Enter a valid zip code for billing");
    } else {
